...
public class VoucherUpdateFragment extends Fragment {
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    public static VoucherUpdateFragment newInstance(String param1, String param2) {
        VoucherUpdateFragment fragment = new VoucherUpdateFragment();
